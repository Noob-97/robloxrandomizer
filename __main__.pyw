...
completedIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/completed.png")
gameinfoIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/gameinfo.png")
gamenumberIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/gamenumber.png")
nextgameIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/nextgame.png")
separatorIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/separator.png")
skipIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/skip.png")
startIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/start.png")
timerIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/timer.png")
welcomeIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/welcome.png")
winlosecountIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/winlosecount.png")
goalreachedIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/goalreached.png")
startnewIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/startnew.png")
continueIMG = tk.PhotoImage(file = f"robloxrandomizerimgs{lang}/continue.png")
...
def init_alt():
    ...
    separator = tk.Label(master=window, image=separatorIMG, background="#010101", width=364)
    welcome = tk.Label(master=window, image=welcomeIMG, background="#010101")
    startbutton.pack(anchor="ne", pady=5)
...
def search(completed = None):
    ...
    match completed:
        ...
        case False:
            resultstatus = "failed"
            resultstatusES = "fallido"
            loses = loses + 1
        case True:
            resultstatus = "completed"
            resultstatusES = "completado"
            wins = wins + 1
        case -1:
            resultstatus = "skipped"
            resultstatusES = "saltado"
            loses = loses + 1
        case "continue":
    ...
    if lang == "EN":
        ...
        resultstext = f"\nduración: {time_taken()} / {playtime_to_hour()}\nresultado: {resultstatusES}"
...
def logSession():
    ...
    json.dump(info, open("robloxrandomizerSession.json", "w"))

def setSession():
    log = json.load(open("robloxrandomizerSession.json", "r"))
    log["wins"] = wins
    log["loses"] = loses
    log["games"] = gamecount
